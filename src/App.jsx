...
const formatLabelsEn = { display: "Display Type", headline: "Headline", infocard: "Info Card", "zoom-label": "Zoom Label", annotation: "Annotation", "panel-text": "Panel Text", "step-overlay": "Step Overlay", comparison: "Comparison", "badge-context": "Badge", "benefit-pill": "Benefit Pill", bullet: "Bullet Point" };
...
const formatWireframes = {
  ...
  headline: (c) => <svg width="64" height="40" viewBox="0 0 64 40"><rect x="1" y="1" width="62" height="38" rx="3" fill={`${c}08`} stroke={`${c}40`} strokeWidth="1"/><rect x="6" y="6" width="36" height="5" rx="1" fill={`${c}30`}/><rect x="6" y="14" width="24" height="3" rx="1" fill={`${c}15`}/><rect x="30" y="16" width="28" height="20" rx="2" fill={`${c}10`} stroke={`${c}20`} strokeWidth="0.5" strokeDasharray="2 1"/></svg>,
  ...
  "benefit-pill": (c) => <svg width="64" height="40" viewBox="0 0 64 40"><rect x="1" y="1" width="62" height="38" rx="3" fill={`${c}06`} stroke={`${c}40`} strokeWidth="1"/><rect x="4" y="8" width="26" height="8" rx="4" fill={`${c}15`} stroke={`${c}25`} strokeWidth="0.5"/><circle cx="9" cy="12" r="2.5" fill={`${c}30`}/><rect x="14" y="10.5" width="12" height="3" rx="1" fill={`${c}30`}/><rect x="4" y="20" width="28" height="8" rx="4" fill={`${c}15`} stroke={`${c}25`} strokeWidth="0.5"/><circle cx="9" cy="24" r="2.5" fill={`${c}30`}/><rect x="14" y="22.5" width="14" height="3" rx="1" fill={`${c}30`}/><rect x="4" y="32" width="24" height="8" rx="4" fill={`${c}15`} stroke={`${c}25`} strokeWidth="0.5"/><circle cx="9" cy="36" r="2.5" fill={`${c}30`}/><rect x="14" y="34.5" width="10" height="3" rx="1" fill={`${c}30`}/><rect x="36" y="10" width="22" height="20" rx="2" fill={`${c}08`} stroke={`${c}15`} strokeWidth="0.5" strokeDasharray="2 1"/></svg>,
...
function FormatLegend({ lang = "de" }) {
  ...
  return <div style={{ ...gS, padding: open ? "14px 16px" : "8px 14px", marginBottom: 10, transition: "all 0.15s" }}>
